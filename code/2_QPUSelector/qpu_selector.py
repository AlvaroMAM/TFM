...
from config.config import KAFKA_SERVER_URL, TOPIC_QPU, TOPIC_QPU_CANDIDATES, TOPIC_WEB
import json
import logging
import os
        ...
        if os.path.isfile(cloud_provider_file):
            ...
            for qpu_machine, machine_information in qpu_machines.items():
                ...
                if is_candidate(machine_information, qubits, shots):
                    ...
                    selected_qpus.append(tuple((qpu_machine.replace(".","_"),qpu_machine_estimation)))
...
if __name__ == '__main__':
    ...
    for message in consumer:
        ...
        for microservice_name, requirements in microservices.items():
            ...
            app_qpu_machines[microservice_name]['mandatory'] = requirements['mandatory']
